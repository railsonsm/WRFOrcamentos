...
public class CaixaFreteView {
	...
	public void init() {
		...
		germanCars.setSelectItems(new SelectItem[] { new SelectItem("BMW", "BMW"),
		...
		americanCars.setSelectItems(new SelectItem[] { new SelectItem("Chrysler", "Chrysler"),
